<?php
/**
 * views/personal_customers/index.php
 * ============================================================
 * 役割:
 * - 個人顧客一覧（DataTables）
 ...
 * - JSは /public/js/personalCustomers.js に分離
...
?>
<div class="k-page personal-customers-index">

  <div class="k-page__header">
    <div>
      <h1 class="k-page__title">個人顧客一覧</h1>
      <div class="k-page__sub">個人顧客の検索・一覧表示を行います。</div>
    </div>

    <div class="d-flex gap-2 flex-wrap">
      <?php if ($canEdit): ?>
        <a class="btn btn-primary" href="/personal_customers/create">新規登録</a>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="k-card mb-3">
    ...
    <div class="k-card__body">
      <form id="personal-customers-filter" class="row g-2 align-items-end k-filter" autocomplete="off" onsubmit="return false;">
        <div class="col-md-2">
        ...
        <div class="col-md-3">
          ...
          <input type="text" name="f_tel01" class="form-control" placeholder="部分一致（ハイフン可）">
        </div>
        ...
        <div class="col-md-4">
          <label class="form-label">ご来社経緯</label>
        ...
        <div class="col-12">
          <div class="d-flex justify-content-center gap-2 mt-3">
            <button type="button" id="personal-customers-filter-apply" class="btn btn-outline-primary btn-sm k-btn-filter">絞り込み</button>
            <button type="button" id="personal-customers-filter-reset" class="btn btn-outline-secondary btn-sm k-btn-filter">リセット</button>
          </div>
        </div>
      </form>
    </div>
  ...
  <div class="k-card k-dt">
    ...
    <div class="k-card__body">
      <div class="datatable-table-wrap">
        <table
          id="personal-customers-table"
          class="table table-striped w-100 datatable-origin k-table"
          data-personal-customers-url="/api/personal_customers"
...
<script src="/js/personalCustomers.js"></script>
